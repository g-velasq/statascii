...
This explains how to propose a change to statascii via a pull request using
Git and GitHub. 
...
the [statascii GitHub repo](https://github.com/gvelasq2/statascii), and 
...
results for [statascii on Travis](https://travis-ci.org/gvelasq2/statascii) (checks on Linux and/or 
